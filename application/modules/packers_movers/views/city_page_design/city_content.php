...
if (empty($city)) {
   ...
   $htmlcontent = "
      ...
      <p>
        People searching for <strong>Top Packers and Movers in $city</strong> usually want one thing &mdash; safe shifting without confusion. Nobody wants broken furniture or late delivery calls after packing their whole house.
      </p>
   ";
   ...
   $htmlcontent1 = "
      ...
      <div class='city-content-card mt-4'>
        ...
        <p>Many customers searching for <strong>Relocating Services Near Me in $city</strong> also ask about part-load shifting. We handle that too &mdash; especially for students and small families. Temporary storage is also available for customers waiting for possession dates.</p>
      </div>
   ";
   ...
   $htmlcontent2 = "
      ...
      <div class='city-content-card mt-4'>
        ...
        <p>A trained mover in <strong>$city</strong> understands apartment restrictions, society permissions, local transport timing, and road conditions &mdash; without unnecessary delays. Our staff uses lifting belts, furniture sliders, and layered wrapping for delicate items.</p>
